	...
	public CrearCurso() {
		...
		btnCrear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String resultado = Curso.crearCurso(new Curso(noCur),"115749802");				
				try {
		...
		btnIngresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String resultado2= Curso.asignarProfesor(codigo, nombreCurso, rutProf,"115749802");
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(codigoYnombre, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(44)
							.addComponent(codigoYnombre, GroupLayout.PREFERRED_SIZE, 13, GroupLayout.PREFERRED_SIZE)))
					.addGap(18)
